# -*- coding: utf-8 -*-
"""
Created on Mon May 31 00:31:55 2021

@author: chandrakant binod th
"""
...
def predict():
    ...
    return render_template('index.html', prediction_text='predict_house_price is {}'.format(predicted_price))
